...
public class FButton extends JButton {
    ...
    public FButton() {
        ...
        fillOver = new Color(178, 164, 38);
        fillClick = new Color(178, 164, 38);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) {
                ...
                line = lineOriginal;
                over = false;
                setCursor(Cursor.getDefaultCursor()); // Cambia el cursor de nuevo al cursor por defecto
                repaint();
            }
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                line = lineOver;
                over = true;
                setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR)); // Cambia el cursor a hand cursor
                repaint();
            }
